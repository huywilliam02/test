...
class DataTableWidgett extends StatefulWidget {
  const DataTableWidgett({super.key});

  @override
  State<DataTableWidgett> createState() => _DataTableWidgetState();
}

class _DataTableWidgetState extends State<DataTableWidgett> {
                            ...
                            Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: toggleContainer,
                                  child:
                                      Image.asset(IconsApp.buttonDistanceLeft),
                                ),
                                SizedBox(
                                  width: 68,
                                  ...
                                  ...(state.dataList ?? []).mapIndexed(
                                    (index, e) => DataRow(
                                      ...
                                      cells: [
                                        ...
                                        DataCell(Center(
                                            child: Text(e.accountCode ?? ''))),
                                        DataCell(Center(
                                            child: Text(e.accountName ?? ''))),
                                        DataCell(Center(
                                            child: Text(
                                                e.patientCode.toString()))),
                                        const DataCell(
                                          Center(
                                            child: Icon(
                                              Icons.check_box,
